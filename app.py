...
.main-header {font-size: 2.5rem; font-weight: bold; color: #1a1a1a; text-align: center;} 噫噫噫 .sub-header {font-size: 1.2rem; color: #666; text-align: center; margin-bottom: 2rem;} .metric-card {background-color: #f8f9fa; padding: 1.5rem; border-radius: 10px; border-left: 5px solid # C5A065;} .quote-box {background-color: #fff; padding: 1.5rem; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); font-style: italic;}
""", unsafe_allow_html=True)

--- 1. 顶部：核心洞察 (The Hook) ---
st.markdown('

LVMH Brand Immersive Experience Report
', unsafe_allow_html=True) 噫噫噫 st.markdown('
From Sensory Touch to Brand Identity | July 2026
', unsafe_allow_html=True)
...
- Ms. Li, First-time Visitor
""", unsafe_allow_html=True)
st.markdown("""
"The VR part was shocking. I couldn't help but share it."
- Mr. Zhang, KOL
""", unsafe_allow_html=True) 
