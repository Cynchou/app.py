...
x=journey_stages,
y=avg_stay,
name="Avg Stay (min)", marker_color='1a1a1a', opacity=0.8), secondary_y=False)
...
xaxis_title="Journey Stages", yaxis_title="Average Stay (Minutes)",
